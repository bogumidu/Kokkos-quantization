...
//    auto *temp_voxels = new Voxel[voxels_deque.size()];
//    for (int i = 0; i < voxels_deque.size(); i++) {
//        temp_voxels[i] = voxels_deque.at(i);
//    }
//    voxels = temp_voxels;
//    std::cout << "VoxelStore::convertToArray() - size: " << voxels_deque.size() << std::endl;
//    return temp_voxels;
