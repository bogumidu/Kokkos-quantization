...
Voxel *voxelization::teselation::quantizationAlgorithm(TempFace *face, int accuracy, Voxel *voxel, VoxelStore *voxelStore) {
...
int voxelization::teselation::getTeselationLevels(Face *face) {
...
bool voxelization::utils::almostEqual(std::vector<double> v1, std::vector<double> v2) {
    ...
    return (((int) v1.front()) == ((int) v2.front()) && ((int) v1.at(1)) == ((int) v2.at(1)) && ((int) v1.back()) == ((int) v2.back()));
}
